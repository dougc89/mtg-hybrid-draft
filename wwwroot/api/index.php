<?php #### consumes and responds with json 
    ...
    require_once($_SERVER['DOCUMENT_ROOT'] . '/meta/inc/utility.php');
    require_once($_SERVER['DOCUMENT_ROOT'] . '/meta/inc/getADinfo.php');
    ...
    $api->authentication()->ad_role('LCSO_IT', 'admin');
